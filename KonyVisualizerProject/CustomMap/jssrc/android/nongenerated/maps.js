...
function frmModeIDETraffic_DataLoad() {
    ...
    frmModeIDETraffic.map1.locationData = [{
        lat: "37.792151",
        lon: "-122.453957",
        name: "Presidio,San Francisco, CA, USA",
        ...
        lat: "37.789709",
        lon: "-122.387009",
        name: "Embarcadero San Francisco, CA, USA",
        desc: "Bank Of America",
        image: "pin_a.png"
    }, {
        lat: "37.791337",
        ...
        desc: "W San Francisco",
        image: "pin_a.png"
    }, {
        lat: "37.790252",
        lon: "-122.411041",
        name: "Downtown San Francisco, CA, USA",
        dex: "Hotel Mark Tiwan",
        image: "pin_a.png"
    }]
}
...
function setAddress() {
    frmStartup.M4BMapViewcustom192741954029725.address = {
        location: "nizampet"
    };
}
...
function closePopup() {
    if (lastPinClicked != null) {
        frmDismissCallout.map1.dismissCallout(lastPinClicked);
    }
}